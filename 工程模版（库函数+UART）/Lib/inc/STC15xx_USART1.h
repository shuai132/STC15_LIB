...
#ifndef __STC15xx_USART_H
#define __STC15xx_USART_H	 
...
extern	u8	USART_Configuration(u8 UARTx, COMx_InitDefine *COMx);
extern	void TX1_write2buff(u8 dat);	//写入发送缓冲，指针+1
extern	void TX2_write2buff(u8 dat);	//写入发送缓冲，指针+1
